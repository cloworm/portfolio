  ...
  return (
    <div className="relative">
      ...
      <header className="min-h-screen flex flex-col justify-center items-center text-center">
        <div>
          <h1 className="text-4xl pb-1">Hi, I&apos;m Chloe Echikson</h1>
          <div className="text-left pb-1">
            <a className="transition-all hover:text-theme_indigo" href="https://www.linkedin.com/in/chloeechikson" aria-label="linkedin" target="_blank" rel="noopener noreferrer">
          ...
          <div className="text-left">
            <a className="transition-all hover:text-theme_indigo" href="http://github.com/cloworm" aria-label="github" target="_blank" rel="noopener noreferrer">
