      ...
      <header className="min-h-screen flex flex-col justify-center items-center text-center">
        <div>
          ...
          <div className="text-left pb-1">
            <a className="transition-all hover:text-theme_pink" href="https://www.linkedin.com/in/chloeechikson" aria-label="linkedin" target="_blank" rel="noopener noreferrer">
          ...
          <div className="text-left">
            <a className="transition-all hover:text-theme_pink" href="http://github.com/cloworm" aria-label="github" target="_blank" rel="noopener noreferrer">
